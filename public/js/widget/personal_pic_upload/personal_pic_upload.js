define([ "jquery", "jquery-ui", "jquery.Jcrop", "jquery.uploadify" ], function() {
    function updatePreview(c) {
        ...
        $("#x1").val(c.x), $("#y1").val(c.y), $("#x2").val(c.x2), $("#y2").val(c.y2), $("#width").val(c.w), 
        $("#height").val(c.h);
    }
    console.log("personal pic loaded"), $(".shadow").css({
        visibility: "visible"
    });
    ...
    $("#target").Jcrop({
        ...
        boundx = bounds[0], boundy = bounds[1], // Store the API in the jcrop_api variable
    ...
    250 > cuterHeight && ($(".jcrop-holder").css({
