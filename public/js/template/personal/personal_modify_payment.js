...
define([ "userBar/userBar", "footer/footer", "sideBar/sideBar", "personal_details/personal_details", "personal_modify_payment_quaoate/personal_modify_payment" ], function() {
    console.log("init");
});