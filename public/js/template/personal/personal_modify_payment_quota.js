require.config({
    ...
    paths: {
        ...
        personal_modify_payment_quaoate: "../wieght/personal_modify_payment_quaoate"
    }
}), // 加载项目所需的所有依赖项
define([ "userBar/userBar", "footer/footer", "sideBar/sideBar", "personal_details/personal_details", "personal_modify_payment_quaoate/personal_modify_payment_quaoate" ], function() {
    console.log("init");
});