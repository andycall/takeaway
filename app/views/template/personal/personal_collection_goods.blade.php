...
@section("rightContent")
    @include("widget.personal_collection_goods.personal_collection_goods")
@stop
...
@section("script")
    {{HTML::script("/js/lib/require.js", ["data-main" => url("js/template/personal/personal_collection_goods.js")])}}
@stop
