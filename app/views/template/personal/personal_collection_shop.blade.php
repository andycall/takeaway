...
@section("rightContent")
    @include("widget.personal_collection_shop.personal_collection_shop")
@stop
...
@section("script")
    {{HTML::script("/js/lib/require.js", ["data-main" => url("js/template/personal/personal_collection_shop.js")])}}
@stop
