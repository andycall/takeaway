<section id="favor_food" class="rst-block">
    ...
    <ul class="rst-aside-menu-list favor_list">
        <li class="rst-aside-dish-item" data-shop-id="hahaha456" data-good-id="mmmm">
            <div class="rst-d-info">
                <p class="rst-d-main text-overflow">
                    <a class="rst-d-name food_name" title="土豆丝牛肉盖饭">土豆丝牛肉盖饭</a>
                </p>
            </div>
            <div class="rst-d-action r_d_a" data-shop-id="xxxxx436" data-good-id="ihrrh5435">
        ...
        <li class="rst-aside-dish-item" data-shop-id="ehrkjh53434" data-good-id="mnxcmbn9569">
                    <div class="rst-d-info">
                        <p class="rst-d-main text-overflow">
                            <a class="rst-d-name food_name" title="土豆丝牛肉盖饭">土豆丝牛肉盖饭</a>
                        </p>
